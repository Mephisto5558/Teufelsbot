 ...
 * @returns {import('discord.js').Member|import('discord.js').User|undefined}will return Member if in guild, else User. if none found, undefined.*/
module.exports = function getTarget({ targetOptionName = 'target', returnSelf }) {
  let target;
  if (this.guild) {
