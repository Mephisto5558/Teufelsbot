...
import type { CommandManagerMember, commandExecutionWrapper } from '@mephisto5558/command';
...
declare function help_getCommands(this: Interaction | Message): CommandManagerMember[];
