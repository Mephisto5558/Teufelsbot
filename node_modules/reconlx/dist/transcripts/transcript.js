...
const generateTranscript = (options) => {
    ...
    return new Promise(async (ful) => {
        fs_1.default.readFile(basePath("template.html"), "utf8", async function (_err, data) {
            if (data) {
                fs_1.default.writeFile(basePath("index.html"), data, async function (err) {
                    if (err)
                    ...
                    fs_1.default.appendFile(basePath("index.html"), info.outerHTML, async function (err) {
                        if (err)
                            return console.log(err);
                        messages.forEach(async (msg) => {
                            ...
                            fs_1.default.appendFile(basePath("index.html"), parentContainer.outerHTML, function (err) {
                                if (err)
                                    return console.log(err);
                            });
                        });
