          ...
          .on('collect', async button => {
            ...
            try {
              const
                ...
                backup = await this.client.backupSystem.load(id, this.guild, { reason: lang('global.modReason', { command: `${this.commandName} load`, user: this.user.username }), statusObj, clearGuildBeforeRestore: !this.options.getBoolean('no_clear') });
