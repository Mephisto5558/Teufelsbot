const economy = {
  ...
  USERID: {
    ...
    maxConcurrentResearches: Number, //The maximum Number of Researches at a time
    gaining: {
    ...
    skills: {
      SKILL_NAME: {
        ...
        maxLvl: Number, //Max lvl
        lvlUpCooldown: Number, //Time in hours it takes to upgrade this item
        onCooldownUntil: Number //Timestamp when the upgrade finished
      },
      currency_bonus_percentage: {
        percentage: 18,
        lastPrice: 0,
