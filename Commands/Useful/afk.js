...
module.exports = {
  ...
  run: async function (lang) {
    ...
    await (global || !this.guildId ? this.client.db.update('userSettings', `${this.user.id}.afkMessage`, { message, createdAt }) : this.client.db.update('guildSettings', `${this.guild.id}.afkMessages.${this.user.id}`, { message, createdAt }));
