...
module.exports = new Command({
  ...
  run: async (client, message, interaction) => {
    ...
    if (message) {
      if (!message.args[0]) message.args = [message.member.roles.highest.id];
      else {
    ...
    const embed = new EmbedBuilder({
      ...
      fields: [
        ...
        ['Color', `[${role.hexColor}](https://www.color-hex.com/color/${role.displayColor})`],
      ...
      .setThumbnail(role.icon ? `https://cdn.discordapp.com/role-icons/${role.guild.id}/${role.icon}.webp?size=80&quality=lossless` : `https://dummyimage.com/80x80/${role.displayColor}/${role.displayColor}.png`);
