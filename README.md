...
## [Add the bot to your server](https://teufel.wisp.uno/invite)
[ToDo List](https://teufel.wisp.uno/vote)

## How to set it up for hosting
### Requirements
```text
Node.js >=24.0.0
MongoDB set up
...
## How to add more languages and change translation texts
